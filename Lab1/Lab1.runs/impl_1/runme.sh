...
HD_PWD='C:/Users/rw22242/FPGA/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binky.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binky.tcl -notrace

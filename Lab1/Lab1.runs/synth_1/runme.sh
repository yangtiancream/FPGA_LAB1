...
HD_PWD='C:/Users/rw22242/FPGA/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binky.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binky.tcl
